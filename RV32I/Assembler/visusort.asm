...
lbu t1, t2, -1 ; t1 <= data[j-1]
lbu t3, t2, 0  ; t3 <= data[j]
.if:
bleu t1, t3, setjump(bubblesort.swaped, bubblesort.if)
sb t3, t2, -1 ; data[j-1] <= data[j]
sb t1, t2, 0  ; data[j] <= data[j-1]
mv a5, t2
mv a6, t1
li a7, stickcolor
addi sp, sp, -4 ; bubblesort関数のraを退避
sw ra, sp, 0
